...
def save_checkpoint(state, is_best, checkpoint):
    ...
    # Write to a temp file then atomically rename, so an interrupted save (job killed
    # mid-write, NFS hiccup) can never leave a truncated/corrupt resume checkpoint.
    tmp = filepath + '.tmp'
